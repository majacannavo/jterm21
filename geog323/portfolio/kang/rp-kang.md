...
Kang et al. used an enhanced two-step floating catchment area method to establish service areas for hospitals in and near Chicago with three different travel-time thresholds, calculate ICU-bed-to-population ratios for each hospital, and sum the weighted ICU-bed-to-population ratios in locations served by multiple hospitals. The result is a choropleth map representing hospital accessibility across Chicago. Low levels of accessibility indicate a need for provision of additional healthcare resources.
